...
FuSystem::FuSystem()
{
	...
	std::shared_ptr<FuEnum> stringComparisonEnum = newEnum(false);
	...
	std::shared_ptr<FuConst> futemp0 = std::make_shared<FuConst>();
	futemp0->visibility = FuVisibility::public_;
	futemp0->id = FuId::stringComparisonCurrentCulture;
	futemp0->name = "CurrentCulture";
	futemp0->visitStatus = FuVisitStatus::done;
	addEnumValue(stringComparisonEnum, futemp0);
	std::shared_ptr<FuConst> futemp1 = std::make_shared<FuConst>();
	futemp1->visibility = FuVisibility::public_;
	futemp1->id = FuId::stringComparisonCurrentCultureIgnoreCase;
	futemp1->name = "CurrentCultureIgnoreCase";
	futemp1->visitStatus = FuVisitStatus::done;
	addEnumValue(stringComparisonEnum, futemp1);
	std::shared_ptr<FuConst> futemp2 = std::make_shared<FuConst>();
	futemp2->visibility = FuVisibility::public_;
	futemp2->id = FuId::stringComparisonOrdinal;
	futemp2->name = "Ordinal";
	futemp2->visitStatus = FuVisitStatus::done;
	addEnumValue(stringComparisonEnum, futemp2);
	std::shared_ptr<FuConst> futemp3 = std::make_shared<FuConst>();
	futemp3->visibility = FuVisibility::public_;
	futemp3->id = FuId::stringComparisonOrdinalIgnoreCase;
	futemp3->name = "OrdinalIgnoreCase";
	futemp3->visitStatus = FuVisitStatus::done;
	addEnumValue(stringComparisonEnum, futemp3);
	add(stringComparisonEnum);
	this->stringClass->addMethod(this->intType, FuId::stringCompareTo, "CompareTo", false, FuVar::new_(this->stringPtrType, "other"), FuVar::new_(stringComparisonEnum, "comparison"));
	...
	futemp4->typeArg0 = this->typeParam0;
	this->arrayPtrClass->addMethod(this->voidType, FuId::arrayCopyTo, "CopyTo", false, FuVar::new_(this->intType, "sourceIndex"), FuVar::new_(futemp4, "destinationArray"), FuVar::new_(this->intType, "destinationIndex"), FuVar::new_(this->intType, "count"));
	...
	futemp5->class_ = listClass;
	futemp5->typeArg0 = this->typeParam0;
	listClass->addMethod(this->voidType, FuId::listAddRange, "AddRange", true, FuVar::new_(futemp5, "source"));
	...
	std::shared_ptr<FuReadWriteClassType> futemp6 = std::make_shared<FuReadWriteClassType>();
	futemp6->class_ = this->arrayPtrClass.get();
	futemp6->typeArg0 = this->typeParam0;
	listClass->addMethod(this->voidType, FuId::listCopyTo, "CopyTo", false, FuVar::new_(this->intType, "sourceIndex"), FuVar::new_(futemp6, "destinationArray"), FuVar::new_(this->intType, "destinationIndex"), FuVar::new_(this->intType, "count"));
	...
	std::shared_ptr<FuStorageType> futemp7 = std::make_shared<FuStorageType>();
	futemp7->class_ = textWriterClass.get();
	consoleClass->add(FuStaticProperty::new_(futemp7, FuId::consoleError, "Error"));
	add(consoleClass);
	...
	futemp8->class_ = this->arrayPtrClass.get();
	futemp8->typeArg0 = this->byteType;
	convertClass->addStaticMethod(this->stringStorageType, FuId::convertToBase64String, "ToBase64String", FuVar::new_(futemp8, "bytes"), FuVar::new_(this->intType, "offset"), FuVar::new_(this->intType, "length"));
	add(convertClass);
	...
	std::shared_ptr<FuReadWriteClassType> futemp9 = std::make_shared<FuReadWriteClassType>();
	futemp9->class_ = this->arrayPtrClass.get();
	futemp9->typeArg0 = this->byteType;
	utf8EncodingClass->addMethod(this->voidType, FuId::uTF8GetBytes, "GetBytes", false, FuVar::new_(this->stringPtrType, "str"), FuVar::new_(futemp9, "bytes"), FuVar::new_(this->intType, "byteIndex"));
	std::shared_ptr<FuClassType> futemp10 = std::make_shared<FuClassType>();
	futemp10->class_ = this->arrayPtrClass.get();
	futemp10->typeArg0 = this->byteType;
	utf8EncodingClass->addMethod(this->stringStorageType, FuId::uTF8GetString, "GetString", false, FuVar::new_(futemp10, "bytes"), FuVar::new_(this->intType, "offset"), FuVar::new_(this->intType, "length"));
	...
	futemp13->id = FuId::jsonValueKindObject;
	futemp13->name = "Object";
	...
	futemp14->id = FuId::jsonValueKindArray;
	futemp14->name = "Array";
	...
	futemp15->id = FuId::jsonValueKindString;
	futemp15->name = "String";
	futemp15->visitStatus = FuVisitStatus::done;
	addEnumValue(jsonValueKindEnum, futemp15);
	std::shared_ptr<FuConst> futemp16 = std::make_shared<FuConst>();
	futemp16->visibility = FuVisibility::public_;
	futemp16->id = FuId::jsonValueKindNumber;
	futemp16->name = "Number";
	futemp16->visitStatus = FuVisitStatus::done;
	addEnumValue(jsonValueKindEnum, futemp16);
	std::shared_ptr<FuConst> futemp17 = std::make_shared<FuConst>();
	futemp17->visibility = FuVisibility::public_;
	futemp17->id = FuId::jsonValueKindTrue;
	futemp17->name = "True";
	futemp17->visitStatus = FuVisitStatus::done;
	addEnumValue(jsonValueKindEnum, futemp17);
	std::shared_ptr<FuConst> futemp18 = std::make_shared<FuConst>();
	futemp18->visibility = FuVisibility::public_;
	futemp18->id = FuId::jsonValueKindFalse;
	futemp18->name = "False";
	futemp18->visitStatus = FuVisitStatus::done;
	addEnumValue(jsonValueKindEnum, futemp18);
	std::shared_ptr<FuConst> futemp19 = std::make_shared<FuConst>();
	futemp19->visibility = FuVisibility::public_;
	futemp19->id = FuId::jsonValueKindNull;
	futemp19->name = "Null";
	futemp19->visitStatus = FuVisitStatus::done;
	addEnumValue(jsonValueKindEnum, futemp19);
	...
	std::shared_ptr<FuClassType> futemp20 = std::make_shared<FuClassType>();
	futemp20->class_ = dictionaryClass;
	futemp20->typeArg0 = this->stringStorageType;
	futemp20->typeArg1 = jsonElementPtr;
	jsonElementClass->add(FuMethod::new_(nullptr, FuVisibility::public_, FuCallType::normal, futemp20, FuId::jsonElementGetObject, "GetObject", false));
	std::shared_ptr<FuClassType> futemp21 = std::make_shared<FuClassType>();
	futemp21->class_ = listClass;
	futemp21->typeArg0 = jsonElementPtr;
	jsonElementClass->add(FuMethod::new_(nullptr, FuVisibility::public_, FuCallType::normal, futemp21, FuId::jsonElementGetArray, "GetArray", false));
